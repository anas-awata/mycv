                  ...
                  <li class="mb-3">
                    <a href="https://t-do.ru/shcok7"
                      ><span class="fa-container text-center mr-2"
                        ><i class="fab fa-telegram-plane fa-fw"></i></span
                      >shcok7</a
                    >
                  </li>
                  <li class="mb-3">
                    <a href="https://vk.com/id19720848"
                      ><span class="fa-container text-center mr-2"
                        ><i class="fab fa-vk fa-fw"></i></span
                      >pspmaniys</a
                    >
                  </li>
                  <li class="mb-3">
                    <a href="https://behance.net/twstrblg"
                      ><span class="fa-container text-center mr-2"
                        ><i class="fab fa-behance fa-fw"></i></span
                      >twstrblg</a
                    >
                  </li>
                  <li>
                    <a href="https://psnprofiles.com/twisterblog"
                      ><span class="fa-container text-center mr-2"
        ...
        <div class="resume-body p-5">
          <section class="resume-section summary-section mb-5">
            ...
            <div class="resume-section-content">
              <p class="mb-0">
                Магистрант Visual Studies в НИУ ВШЭ, пишу и редактирую тексты.
                Занимаюсь академическими исследованиями видеоигр, веду про это
                <a href="http://t-do.ru/twisterblog" target="_blank"
                  >блог в Телеграме.</a
                >
                Езжу по России и миру, фотографирую в поездках. Фотографии
                выкладываю на Биханс.
              </p>
            </div>
          </section>
          <div class="row">
                  ...
                  <div class="resume-timeline position-relative">
                    ...
                    >
                      ...
                      <div class="resume-timeline-item-desc">
                        <p>
                          Делаю всё, что связано с соцсетями и текстами. Пишу
                          рассылки и посты. Верстаю лендинги, перевожу
                          пресс-релизы, делаю спецпроекты.
                        </p>
                        <ul>
                          <li>
                            <a
                              ...
                              target="_blank"
                              >«Метро в Российской империи»</a
                            >
                          </li>
                          <li>
                            <a
                              href="https://vk.com/russianimp?w=wall-44693766_143639"
                              target="_blank"
                              >Смешные дореволюционные журналы</a
                            >
                          </li>
                          <li>
                            <a
                              href="https://www.instagram.com/p/ByzmsdVopko/"
                              target="_blank"
                              >Политические мемы</a
                            >
                          </li>
                    ...
                    >
                      ...
                      <div class="resume-timeline-item-desc">
                        <p>
                          Написал много текстов, разобрался в куче тем. Теперь
                          не боюсь SEO-ключей и делаю вэнити-серч на заказ.
                        </p>
                        <ul>
                          <li>
                            <a
                              href="https://docs.google.com/document/d/1iklxr2ouDfpWy2oLBvaYV86htCMz92rsEYtqV0JmDsU/edit"
                              target="_blank"
                              >Как протезировать зубы</a
                            >
                          </li>
                          <li>
                            <a
                              href="https://docs.google.com/document/d/1aehTEK9_h4LxfCoUifVDXXIc8T3LOVgoZK6ITh_Fka4/edit"
                              target="_blank"
                              >Зачем чистить кондиционеры</a
                            >
                          </li>
                          <li>
                            <a
                              href="https://docs.google.com/document/d/1apokmN9otgZ2iSTMzgwElkuRLKS_QKM5G4WvHbT2iCM/edit"
                              target="_blank"
                              >Почему Москва растёт на Юго-Запад</a
                            >
                          </li>
                        </ul>
                      </div>
                    ...
                    >
                      ...
                      <div class="resume-timeline-item-desc">
                        <p>
                          Взял три интервью и написал на их основе текст в блог
                          Mail.ru.
                        </p>
                        <ul>
                          <li>
                            <a
                              href="https://mcs.mail.ru/blog/ml-business/"
                              target="_blank"
                              >Машинное обучение для торговли</a
                            >
                          </li>
                        </ul>
                      </div>
                    ...
                    <article class="resume-timeline-item position-relative">
                      ...
                      <div class="resume-timeline-item-desc">
                        <p>
                          Руководил Телеграм-каналом, учил стажёров писать
                          смешные посты, рисовал картинки и вёл прямые репортажи
                          в одном студмедиа. Писал подборки, обзоры и переводил
                          материалы в университетский академический журнал в
                          другом
                        </p>
                        <ul>
                          <li>
                            <a
                              href="https://thevyshka.ru/16885-zasedanie-studsoveta-niu-vshe-tragediya-pgas/"
                              target="_blank"
                              >Репортаж с заседания Студсовета</a
                            >
                          </li>
                          <li>
                            <a
                              href="https://t-do.ru/thevyshka/2927"
                              target="_blank"
                              >Инструкция к блокирующим оценкам</a
                            >
                          </li>
                          <li>
                            <a
                              href="https://doxajournal.ru/translations/accelerate"
                              target="_blank"
                              >Перевод книги Марка Фишера
                            </a>
                          </li>
                          <li>
                            <a
                              href="https://thevyshka.ru/16885-zasedanie-studsoveta-niu-vshe-tragediya-pgas/"
                              target="_blank"
                              >Рецензия на «Снежного человека»</a
                            >
                          </li>
                          <li>
                            <a
                              href="https://doxa.tilda.ws/texts/reviews/games_05_10_17"
                              target="_blank"
                              >Дайджест видеоигр в сентябре 2018</a
                            >
                          </li>
                        </ul>
                      </div>
                    ...
                    >
                      ...
                      <div class="resume-timeline-item-desc">
                        <p>
                          Сочинял подборки игр, описывал инфоповоды в игровой
                          индустрии.
                        </p>
                        <ul>
                          <li>
                            <a
                              href="https://vk.com/@igm-igrovaya-impotenciya-top-samyh-unylyh-igr"
                              target="_blank"
                              >Игровая импотенция</a
                            >
                          </li>
                          <li>
                            <a
                              href="https://vk.com/@igm-geforce-gaming-celebration-na-gamescom-2018"
                              target="_blank"
                              >Обзор мероприятия GeForce</a
                            >
                          </li>
                          <li>
                            <a
                              href="https://vk.com/@igm-6-prichin-pochemu-my-vozvraschaemsya-v-igry"
                              target="_blank"
                              >Исследование причин реиграбельности</a
                            >
                          </li>
                        </ul>
                      </div>
                  ...
                  <div class="resume-skill-item">
                    ...
                    <ul class="list-inline">
                      <li class="list-inline-item">
                        <span class="badge badge-light">Верховая езда</span>
                      </li>
                      <li class="list-inline-item">
                        <span class="badge badge-light">Гитара</span>
                      </li>
                      <li class="list-inline-item">
                        <span class="badge badge-light">Фортепиано</span>
                      </li>
                      <li class="list-inline-item">
                        <span class="badge badge-light">Гребля</span>
                      </li>
                      <li class="list-inline-item">
                        <span class="badge badge-light">Видеоигры</span>
                      </li>
                      <li class="list-inline-item">
                        <span class="badge badge-light">Типографика</span>
                      </li>
                      <li class="list-inline-item">
                        <span class="badge badge-light">Плавание</span>
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div class="resume-section-content">
                  <ul class="list-unstyled resume-awards-list">
                    ...
                    <li class="mb-0 pl-4 position-relative">
                      ...
                      ></i>
                      <div class="resume-award-name">
                        Школой редакторов Бюро Горбунова
                      </div>
                      <div class="resume-award-desc">
                        <a
                          href="https://bureau.ru/burosfera/stas-zveryanov"
                          target="_blank"
                          >И кабинетом в Бюросфере</a
                        >
                      </div>
                    </li>
                  </ul>
                  ...
                  <ul class="list-unstyled resume-lang-list">
                    ...
                    <li>
                      <span class="resume-lang-name font-weight-bold"
                        >Немецком</span
                      >
                      <small class="text-muted font-weight-normal">(В1)</small>
                    </li>
                  </ul>
                </div>
              </section>
