  ...
  <div class="wrapper">
    <div class="intro">
      ...
      <div class="intro-section about">
        ...
        <p class="paragraph">
          Hi everyone, I am a web front-end developer, graduated from NTHU,
          Taiwan and my major is CS. I recently try my best to improve my skills
          on web front-end. My favorite thing is to observe others' portfolio.
        </p>
      </div>
      <div class="intro-section contact">
        ...
        <div class="info-section link">
          ...
          <a
            target="_blank"
            rel="author"
            href="https://www.facebook.com/profile.php?id=100006277752355"
          >
            <span>陳志祥</span>
          </a>
        </div>
      ...
      <div class="intro-section follow">
        ...
        <div class="info-section link">
          ...
          <a
            target="_blank"
            rel="author"
            href="https://github.com/chih-hsi-chen"
          >
        ...
        <div class="info-section link">
          ...
          <a
            target="_blank"
            rel="author"
            href="https://codepen.io/chih-hsi-chen"
          >
